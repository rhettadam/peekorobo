frc_games = {
        ...
        2024: {"name": "Crescendo", 
               ...
               "manual": "https://firstfrc.blob.core.windows.net/frc2024/Manual/2024GameManual.pdf",
               "summary": "Two competing alliances score notes, amplify their speaker, harmonize onstage, and take the spotlight before time runs out. First 15 seconds, robots are autonomous. Robots leave their starting zone, score notes in their speaker or amp, and collect and score additional notes. The remaining 2 minutes and 15 seconds, drivers control their robots. Robots collect notes and score them in their amp and speaker. Each time an alliance gets 2 notes in their amp, the human player can amplify their speaker for 10 seconds. As time runs out, robots race to get onstage and deliver notes to their traps. Harmonizing robots, i.e. robots sharing a chain, earn an added bonus. Robots earn even more points if a human player spotlights robots on a chain by scoring a note on the chain’s microphone. The alliance that earns the most points wins the match!"},
        ...
        2021: {"name": "Infinite Recharge 2", 
               ...
               "summary": "In INFIRNITE RECHARGE, two alliances work to protect FIRST City from approaching asteroids caused by a distant space skirmish. Each Alliance, along with their trusty droids, race to collect and score Power Cells in order to energize their Shield Generator for maximum protection. To activate stages of the Shield Generator, droids manipulate their Control Panels after scoring a specific number of Power Cells. Near the end of the match, droids race to their Rendezvous Point to get their Shield Generator operational in order to protect the city!"},
        ...
        2005: {"name": "Triply Play", 
               ...
               "summary": "The game for the 2005 season is played on a 27 foot wide by 52 foot long playing field with the 9 goals configured in 3 x 3 matrix, similar to tic-tac-toe. The robots will attempt to place the red and blue game tetras in or on one or more of the nine goals to score points and claim ownership of the goals."},
