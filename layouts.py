            ...
            html.Div([
                ...
                html.Ul([
                    ...
                    html.Ul([
                        ...
                        html.Li([html.Strong("SoS: "), "Mean predicted qualification win probability for your alliance (model). Higher = more often favored; correlates with team strength and draw. Avg opponent/partner ACE are shown for context."]),
