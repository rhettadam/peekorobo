            ...
            html.Div([
                ...
                html.Ul([
                    ...
                    html.Ul([
                        ...
                        html.Li([html.Strong("SoS: "), "Schedule ease at this event (1 = easiest, 0 = hardest): mean opponent and mean partner ACE over QMs, each min–max normalized across the field, then averaged. Win probabilities still label hardest/easiest matches."]),
        ...
        [
            ...
            dbc.Container(
                [
                    ...
                    html.Div(id="compare-season-summary"),
                ],
                style={"padding": "20px", "maxWidth": "1200px", "margin": "0 auto"},
            ),
            footer,
